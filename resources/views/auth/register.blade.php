...
@section('content')
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" id="name" aria-describedby="emailHelp" value="{{old("nama")}}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-4">
            <label for="exampleInputPassword1" class="form-label">Ulangi Sandi</label>
